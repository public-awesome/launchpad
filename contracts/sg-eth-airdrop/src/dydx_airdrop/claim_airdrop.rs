use crate::dydx_airdrop::query::query_collection_whitelist;
use crate::dydx_airdrop::state::ADDRS_TO_MINT_COUNT;
use crate::dydx_airdrop::{state::CONFIG, ContractError};
...
mod validation {
    ...
    use crate::{
        dydx_airdrop::query::{query_airdrop_is_eligible, query_per_address_limit},
        dydx_airdrop::state::Config,
    };
