use crate::{create_fund_community_pool_msg, NATIVE_DENOM};
...
pub fn handle_fee<T>(
    ...
    info: &MessageInfo,
    expected_fee: u128,
) -> Result<Vec<CosmosMsg<T>>, FeeError> {
    ...
    Ok(vec![
        cosmwasm_std::CosmosMsg::Bank(send_fee_msg),
        cosmwasm_std::CosmosMsg::Bank(fee_burn_msg),
