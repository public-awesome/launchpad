use crate::dydx_airdrop::constants::claim_constants::{NATIVE_DENOM, STARGAZE_WALLET_01};
use crate::dydx_airdrop::constants::collection_constants::{MINT_PRICE, WHITELIST_AMOUNT};
...
pub fn execute_airdrop_claim(
    ...
    let claim_message = dydx_airdrop::msg::ExecuteMsg::ClaimAirdrop {
