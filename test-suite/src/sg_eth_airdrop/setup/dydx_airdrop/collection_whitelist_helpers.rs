...
use crate::sg_eth_airdrop::constants::dydx_airdrop::collection_constants::{
    MINT_PRICE, WHITELIST_AMOUNT,
};

use crate::sg_eth_airdrop::setup::dydx_airdrop::execute_msg::execute_contract_with_msg;
...
pub fn execute_airdrop_claim(
    ...
    let claim_message = sg_eth_airdrop::dydx_airdrop::msg::ExecuteMsg::ClaimAirdrop {
