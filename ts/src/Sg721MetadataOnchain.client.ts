...
export interface Sg721MetadataOnchainInterface extends Sg721MetadataOnchainReadOnlyInterface {
  contractAddress: string;
  sender: string;
...
export class Sg721MetadataOnchainClient extends Sg721MetadataOnchainQueryClient implements Sg721MetadataOnchainInterface {
  ...
  ready = async (fee: number | StdFee | "auto" = "auto", memo?: string, funds?: Coin[]): Promise<ExecuteResult> => {
