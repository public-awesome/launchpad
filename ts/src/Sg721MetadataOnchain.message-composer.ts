...
export interface Sg721MetadataOnchainMessage {
  contractAddress: string;
  sender: string;
  ready: (funds?: Coin[]) => MsgExecuteContractEncodeObject;
  transferNft: ({
    recipient,
    tokenId
  }: {
...
export class Sg721MetadataOnchainMessageComposer implements Sg721MetadataOnchainMessage {
  sender: string;
  contractAddress: string;
